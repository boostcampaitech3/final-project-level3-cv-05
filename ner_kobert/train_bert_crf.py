...
import sys
sys.path.append('/opt/ml/ocr/ner/ner_kobert')
...
def main(parser):
    ...
    cwd = Path.cwd()
    # data_in = cwd / "data_in"
    data_in = "/opt/ml/ocr/ner/ner_kobert/data_in"
    # train_data_dir = data_in / "NER-master" / "corpus-morph_entity"
    train_data_dir = "/opt/ml/ocr/ner/ner_kobert/data_in/NER-master/corpus-morph_entity"
    ...
    val_data_dir = "/opt/ml/ocr/ner/ner_kobert/data_in/NER-master/validation_set"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', default='/opt/ml/ocr/ner/ner_kobert/data_in', help="Directory containing config.json of data")
    parser.add_argument('--model_dir', default='/opt/ml/ocr/ner/ner_kobert/experiments/base_model_with_crf_val', help="Directory containing config.json of model")
